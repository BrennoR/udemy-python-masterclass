...
class DataListBox(Scrollbox):
    ...
    def requery(self, link_value=None):
        self.link_value = link_value    # store the ID so we know the "master" record we populated from
    ...
    def on_select(self, event):
        if self.linked_box:
            print(self is event.widget)     # TODO delete this line later
...
if __name__ == "__main__":
    ...
    songList = DataListBox(mainWindow, conn, "songs", "title", sort_order=("track",))
    # songList.requery()
